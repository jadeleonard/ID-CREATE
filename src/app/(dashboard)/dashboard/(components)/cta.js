export default function Cta() {
    return(
        <div>
            <section class="bg-transparent dark:bg-gray-900 flex flex-col items-center mx-auto">
    <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
        <div class="max-w-screen-md">
            <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Experience the Future of Healthcare</h2>
            <p class="mb-8 font-light text-gray-100 sm:text-xl dark:text-gray-400">  - Connect your health cards, access vital information, and take control of your well-being. Join HealthCare ID today!
</p>
            <div class="flex flex-col space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4">
                <a href="#" class="inline-flex items-center justify-center px-4 py-2.5 text-base font-medium text-center text-white bg-blue-200 rounded-lg hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900">
                    Get started
                </a>
...
<div class="px-6 py-12 text-center md:px-12 lg:text-left bg-transparent">
...
<div class="bg-transparent dark:bg-gray-900 flex flex-col items-center mx-auto">
    <div class="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
        ...
        <div class="mt-4 md:mt-0">
            ...
            <p class="mb-6 font-light text-gray-500 md:text-lg dark:text-gray-400"> - Secure Health ID Creation</p>
            <p class="mb-6 font-light text-gray-500 md:text-lg dark:text-gray-400">- Link Multiple Health Cards</p>
            <p class="mb-6 font-light text-gray-500 md:text-lg dark:text-gray-400">  - Accessible Documentation
</p>
            <p class="mb-6 font-light text-gray-500 md:text-lg dark:text-gray-400">  - Step-by-Step Tutorials
</p>            
<p class="mb-6 font-light text-gray-500 md:text-lg dark:text-gray-400">  - Privacy and Security Assurance
